...
fitness_func.fitness[int(n/2)-1] = 0.65
fitness_func.fitness[int(n/2)+1] = 0.65
fitness_func.fitness[int(n/2)-2] = 0.5
fitness_func.fitness[int(n/2)+2] = 0.5
fitness_func.fitness[int(n/2)-3] = 0.25
fitness_func.fitness[int(n/2)+3] = 0.25
fitness_func.fitness[int(n/2)-4] = 0.5
fitness_func.fitness[int(n/2)+4] = 0.5
fitness_func.fitness[int(n/2)-5] = 0.5
fitness_func.fitness[int(n/2)+5] = 0.5
fitness_func.fitness[int(n/2)-6] = 0.25
fitness_func.fitness[int(n/2)+6] = 0.25
fitness_func.fitness[int(n/2)-7] = 0.5
fitness_func.fitness[int(n/2)+7] = 0.5
fitness_func.fitness[int(n/2)-8] = 0.5
fitness_func.fitness[int(n/2)+8] = 0.5
fitness_func.fitness[int(n/2)-9] = 0.75
fitness_func.fitness[int(n/2)+9] = 0.75
...
mutation_obj.Q[int(n/2),int(n/2)+1] = .15
mutation_obj.Q[int(n/2),int(n/2)-1] = .15
mutation_obj.Q[int(n/2),int(n/2)+2] = .2
mutation_obj.Q[int(n/2),int(n/2)-2] = .2
mutation_obj.Q[int(n/2),int(n/2)+3] = .15
mutation_obj.Q[int(n/2),int(n/2)-3] = .15
#mutation_obj.Q[int(n/2),int(n/2)+4] = .25
#mutation_obj.Q[int(n/2),int(n/2)-4] = .25
#mutation_obj.Q[int(n/2),int(n/2)+5] = .2
#mutation_obj.Q[int(n/2),int(n/2)-5] = .2
#mutation_obj.Q[int(n/2),int(n/2)+6] = .5
#mutation_obj.Q[int(n/2),int(n/2)-6] = .5
#mutation_obj.Q[int(n/2),int(n/2)+7] = .25
#mutation_obj.Q[int(n/2),int(n/2)-7] = .25
#mutation_obj.Q[int(n/2),int(n/2)+8] = .2
#mutation_obj.Q[int(n/2),int(n/2)-8] = .2
#mutation_obj.Q[int(n/2),int(n/2)+9] = .15
#mutation_obj.Q[int(n/2),int(n/2)-9] = .15
